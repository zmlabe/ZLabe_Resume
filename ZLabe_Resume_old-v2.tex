...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Experience %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vspace{-0.09in}
\cvsection[page1sidebar_old-v2]{Background}
\begin{itemize}
    \setlength{\itemindent}{0.5em}
    \item[--] \small{Interested in the role of climate change on prediction, extremes, \& variability}
    \item[--] \small{Published 33 peer-reviewed scientific articles (journals/technical reports)}
...
\cvevent{Research Physical Scientist (NOAA Federal)}{Geophysical Fluid Dynamics Laboratory (GFDL)}{June 2024 -- Ongoing}{Princeton, NJ}
\begin{itemize}
    \setlength{\itemindent}{0.5em}
...
\cvevent{Postdoc/Associate Research Scholar}{Princeton University \& NOAA GFDL}{May 2022 -- June 2024}{Princeton, NJ}
\begin{itemize}
    \setlength{\itemindent}{0.5em}
